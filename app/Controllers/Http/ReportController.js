    ...
    async vehicleReport ({ params }) {
      try {
        ...
        var docDefinition = {
          ...
          content: [
            /*{ text: [vehicle.brand+' '+ vehicle.model] , fontSize: 15, alignment:'center'},
            { text: 'Tipo: '+ vehicle.type, style: 'body'},
            { text: 'KM Atual: '+ vehicle.km_current, style: 'body'},
            { text: 'Ano: '+ vehicle.year, style: 'body'},
            { text: 'Placa: '+ vehicle.plate, style: 'body'},
            { text: 'Nª Chassis: '+ vehicle.chassis_number, style: 'body'},
            { text: 'Preço de Compra: '+ vehicle.purchase_price, style: 'body'},
            { text: 'Data de Compra: '+ purchase_date, style: 'body'},
            { text: 'Valor de Venda: '+ vehicle.sale_value, style: 'body'},*/
    ...
    async cartReport ({ params }) {
      try{
        ...
        var docDefinition = {
          ...
          content: [
            { text: [cart.brand+' '+ cart.model] , fontSize: 15, alignment:'center'},
            { text: 'Tipo: '+ cart.type, style: 'body'},
            { text: 'KM Atual: '+ cart.km_current, style: 'body'},
            { text: 'Ano: '+ cart.year, style: 'body'},
            { text: 'Placa: '+ cart.plate, style: 'body'},
            { text: 'Nª Chassis: '+ cart.chassis_number, style: 'body'},
            { text: 'Preço de Compra: '+ cart.purchase_price, style: 'body'},
            { text: 'Data de Compra: '+ purchase_date, style: 'body'},
            { text: 'Valor de Venda: '+ cart.sale_value, style: 'body'},
          ],
